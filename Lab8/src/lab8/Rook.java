...
public class Rook extends Piece {
  ...
  public Rook(String name, PieceColor pieceColor, int currentRow, int currentCol) {
  ...
  public void move(Board board, int tarRow, int tarCol) {
    ...
    if (!(tarRow == curRow || tarCol == curCol)) {
    System.out.println("Rooks can move horizontally or vertically on the board");
    return;
}
